...
export default class Pagination extends PureComponent {
    ...
    static propTypes = {
        ...
        containerStyle: ViewPropTypes ? ViewPropTypes.style : PropTypes.any,
        dotColor: PropTypes.string,
        dotContainerStyle: ViewPropTypes ? ViewPropTypes.style : PropTypes.any,
        dotElement: PropTypes.element,
        dotStyle: ViewPropTypes ? ViewPropTypes.style : PropTypes.any,
        inactiveDotColor: PropTypes.string,
        inactiveDotElement: PropTypes.element,
        inactiveDotOpacity: PropTypes.number,
        inactiveDotScale: PropTypes.number,
        inactiveDotStyle: ViewPropTypes ? ViewPropTypes.style : PropTypes.any,
